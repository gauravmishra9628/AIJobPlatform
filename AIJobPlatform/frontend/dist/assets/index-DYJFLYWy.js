(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[{title:`AI Product Analyst`,company:`NexaWorks`,location:`Remote`,salary:`$92k - $118k`,match:94,type:`Full-time`,skills:[`Prompting`,`SQL`,`Dashboards`]},{title:`Machine Learning Engineer`,company:`SignalForge`,location:`Bengaluru`,salary:`$120k - $150k`,match:89,type:`Hybrid`,skills:[`Python`,`PyTorch`,`MLOps`]},{title:`AI Resume Reviewer`,company:`CareerPilot`,location:`New York`,salary:`$76k - $96k`,match:86,type:`Contract`,skills:[`NLP`,`Hiring`,`Feedback`]}],t=[[`1,284`,`Active jobs`],[`82%`,`Avg. match score`],[`19 min`,`Fastest shortlist`]];document.querySelector(`#app`).innerHTML=`
          ...
          <div class="mt-6 grid grid-cols-3 gap-3">
            ${t.map(([e,t])=>`
                  <div class="rounded-md border border-[#edf0eb] bg-[#fafbf8] p-3">
                    <p class="text-xl font-bold text-[#17211c]">${e}</p>
                    <p class="mt-1 text-xs font-medium text-[#526157]">${t}</p>
                  </div>
                `).join(``)}
          </div>
        </div>
        ...
        ${e.map(e=>`
              <article class="job-card rounded-lg border border-[#dfe4dc] bg-white p-5 shadow-sm">
                <div class="flex items-start justify-between gap-4">
                  <div>
                    <h3 class="text-lg font-bold text-[#17211c]">${e.title}</h3>
                    <p class="mt-1 text-sm font-medium text-[#526157]">${e.company} · ${e.location}</p>
                  </div>
                  <span class="rounded-full bg-[#e4f3ec] px-3 py-1 text-sm font-bold text-[#1b5e4b]">${e.match}%</span>
                </div>
                <div class="mt-5 flex flex-wrap gap-2">
                  ${e.skills.map(e=>`
                        <span class="rounded-md border border-[#dfe4dc] bg-[#fafbf8] px-2.5 py-1 text-xs font-semibold text-[#526157]">${e}</span>
                      `).join(``)}
                </div>
                <div class="mt-6 flex items-center justify-between border-t border-[#edf0eb] pt-4">
                  <div>
                    <p class="text-sm font-bold text-[#17211c]">${e.salary}</p>
                    <p class="mt-1 text-xs font-medium text-[#526157]">${e.type}</p>
                  </div>
